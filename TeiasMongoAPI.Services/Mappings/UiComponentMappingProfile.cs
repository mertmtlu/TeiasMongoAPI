    ...
    public class UiComponentMappingProfile : Profile
    {
        public UiComponentMappingProfile()
        {
            ...
            CreateMap<UiComponentCreateDto, UiComponent>()
                ...
                .ForMember(dest => dest.ProgramId, opt => opt.MapFrom(src => !string.IsNullOrEmpty(src.ProgramId) ? ObjectId.Parse(src.ProgramId) : (ObjectId?)null))
            ...
            CreateMap<UiComponent, UiComponentDto>()
                ...
                .ForMember(dest => dest.ProgramId, opt => opt.MapFrom(src => src.ProgramId.HasValue ? src.ProgramId.Value.ToString() : null));
