...
namespace TeiasMongoAPI.Services.Interfaces
{
    public interface IRemoteAppService
    {
        ...
        Task<List<RemoteAppPermissionDto>> GetRemoteAppPermissionsAsync(string id, CancellationToken cancellationToken = default);
        Task<RemoteAppDto> AddUserPermissionAsync(string id, RemoteAppUserPermissionDto dto, CancellationToken cancellationToken = default);
        Task<RemoteAppDto> UpdateUserPermissionAsync(string id, RemoteAppUserPermissionDto dto, CancellationToken cancellationToken = default);
        Task<bool> RemoveUserPermissionAsync(string id, string userId, CancellationToken cancellationToken = default);
        Task<RemoteAppDto> AddGroupPermissionAsync(string id, RemoteAppGroupPermissionDto dto, CancellationToken cancellationToken = default);
        Task<RemoteAppDto> UpdateGroupPermissionAsync(string id, RemoteAppGroupPermissionDto dto, CancellationToken cancellationToken = default);
        Task<bool> RemoveGroupPermissionAsync(string id, string groupId, CancellationToken cancellationToken = default);
