...
namespace TeiasMongoAPI.API.Controllers
{
    ...
    public class UiComponentsController : BaseController
    {
        ...
        /// <summary>
        /// Get global UI components
        /// </summary>
        [HttpGet("global")]
        [RequirePermission(UserPermissions.ViewComponents)]
        public async Task<ActionResult<ApiResponse<PagedResponse<UiComponentListDto>>>> GetGlobalComponents(
            [FromQuery] PaginationRequestDto pagination,
            CancellationToken cancellationToken = default)
        {
            return await ExecuteAsync(async () =>
            {
                return await _uiComponentService.GetGlobalComponentsAsync(pagination, cancellationToken);
            }, "Get global UI components");
        }
        ...
        /// <summary>
        /// Get UI components available for program
        /// </summary>
        [HttpGet("programs/{programId}/available")]
        [RequirePermission(UserPermissions.ViewComponents)]
        public async Task<ActionResult<ApiResponse<PagedResponse<UiComponentListDto>>>> GetAvailableForProgram(
            string programId,
            [FromQuery] PaginationRequestDto pagination,
            CancellationToken cancellationToken = default)
        {
            ...
            return await ExecuteAsync(async () =>
            {
                return await _uiComponentService.GetAvailableForProgramAsync(programId, pagination, cancellationToken);
            }, $"Get UI components available for program {programId}");
        }
